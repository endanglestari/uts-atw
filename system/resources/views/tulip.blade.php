...
<head>
	...
	<link id="callCss" rel="stylesheet" href="{{url('public')}}/themes/css/bootstrap.min.css" type="text/css" media="screen" charset="utf-8" />
	<link id="callCss" rel="stylesheet" href="{{url('public')}}/themes/css/style.css" type="text/css" media="screen" charset="utf-8" />
	<link href="{{url('public')}}/themes/css/bootstrap-responsive.min.css" rel="stylesheet">
	<link rel="stylesheet" href="{{url('public')}}/themes/font-awesome/css/font-awesome.min.css">
	<!--[if IE 7]>
...
<body data-spy="scroll" data-target=".navbar">
	...
	<div class="container">
		<h1 class="brand cntr">Flowers</h1>
		<div class="navbar">
		...
		<div id="myCarousel" class="carousel slide">
			<div class="carousel-inner">
				<div class="item active">
					<a class="cntr" href="#"><img src="{{url('public')}}/themes/images/carousel/1.png" alt=""></a>
				</div>
				<div class="item">
					<a class="cntr" href="#"><img src="{{url('public')}}/themes/images/carousel/2.png" alt=""></a>
				</div>
				<div class="item">
					<a class="cntr" href="#"><img src="{{url('public')}}/themes/images/carousel/3.png" alt=""></a>
				</div>
				<div  class="item">
					<a class="cntr" href="#"><img src="{{url('public')}}/themes/images/carousel/4.png" alt=""></a>
				</div>
				<div class="item">
					<a class="cntr" href="#"><img src="{{url('public')}}/themes/images/carousel/5.png" alt=""></a>
				</div>
			</div>
...
<div id="welcomeSection"> 
	<div class="container cntr">
			...
			<div class="carousel-inner">
				<div class="item active">
					<p> Phasellus et velit est, non lacinia sem.<br/><br/></p>
				</div>
				<div class="item">
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.  non lacinia sem.<br/><br/></p>
				</div>
				<div class="item">
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. velit est, non lacinia sem.<br/><br/></p>
				</div>
			</div>
...
<div class="tab-content label-primary">
	...
	<li class="span3">
		<div class="thumbnail">
			<div class="blockDtl">
			<a href="#"><img src="{{url('public')}}/themes/images/portfolio/1.jpg" alt=""></a>
	...
	<li class="span3">
		<div class="thumbnail">
			<div class="blockDtl">
			<a href="#"><img src="{{url('public')}}/themes/images/portfolio/2.jpg" alt=""></a>
			<h4>Easy Interface</h4>
			<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, </p>
			</div>
		</div>
...
<div class="row">
	<div class="span9">
		...
		<p><img src="{{url('public')}}/themes/img/1.png" class="attachment-wide wp-post-image" alt="78" title="78"></p>
		...
		<p><img src="{{url('public')}}/themes/img/2.png" class="attachment-wide wp-post-image" alt="78" title="78"></p>
		<p>Vivamus commodo placerat libero, eget pulvinar felis lobortis in. Curabitur ac enim nibh. Cras in odio nisi. Fusce et augue velit. 
		Nulla convallis, ipsum vitae tristique pretium, sapien odio viverra quam, eget mollis diam risus ut mi. Nullam ultrices ornare nisl,
		 sagittis ullamcorper dolor rutrum vitae. Sed accumsan mauris eget elit dictum vitae dapibus nisl [...]</p>
		<p>
		...
		<h1><a href="#" rel="bookmark" title="Permanent Link to Cras in odio nisi">Cras in odio nisi</a></h1>
		<p class="meta">Added by <a href="#" title="Posts by admin">admin</a> on <a href="#">November 14th, 2010</a>, filed under <a href="#" title="View all posts in Category 3" rel="category">Category 3</a></p>
		<p><img src="{{url('public')}}/themes/img/3.png" class="attachment-wide wp-post-image" alt="78" title="78"></p>
		<p>Vivamus commodo placerat libero, eget pulvinar felis lobortis in. Curabitur ac enim nibh. Cras in odio nisi. Fusce et augue velit. 
		Nulla convallis, ipsum vitae tristique pretium, sapien odio viverra quam, eget mollis diam risus ut mi. Nullam ultrices ornare nisl,
		 sagittis ullamcorper dolor rutrum vitae. Sed accumsan mauris eget elit dictum vitae dapibus nisl [...]</p>
		<p>
...
<script src="{{url('public')}}/themes/js/jquery-1.9.1.min.js"></script>
<script src="{{url('public')}}/themes/js/bootstrap.min.js" type="text/javascript"></script>
<script src="{{url('public')}}/themes/js/jquery.scrollTo-1.4.3.1-min.js" type="text/javascript"></script>
<script src="{{url('public')}}/themes/js/jquery.easing-1.3.min.js"></script>
<script src="{{url('public')}}/themes/js/jquery.scrollTo-1.4.3.1-min.js"></script>
<script src="{{url('public')}}/themes/js/default.js"></script> 
